...
The following derivation is reproduced from Berry~\cite{BerryThesis2013} and is based upon the analysis of Kevorkian~\cite{Kevorkian1987}.\footnote{The same two time-scale theory underpins the analysis of Hinderer and Flanagan~\cite{Hinderer2008}, but this explicitly ignores resonances.} Small adjustments have been made to adapt to the specific problem of GW inspiral, but the general argument is unchanged. A similar derivation can be found by van de Meent~\cite{VanDeMeent2014}.
