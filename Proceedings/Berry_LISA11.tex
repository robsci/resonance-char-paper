...
%\begin{figure}
%  \centering
%   \subfigure[\label{fig:eccentricity}]{\includegraphics[width=0.45\columnwidth]{Fig_e_rms_p}} \quad
%   \subfigure[\label{fig:SNR}]{\includegraphics[width=0.45\columnwidth]{Fig_res_pop_SNR_overlap}}
